...
SET(GLOBAL_SOVERSION "${CMake_VERSION_MAJOR}.${CMake_VERSION_MINOR}")
...
ADD_CUSTOM_TARGET(release ${BASH} "chmod +x build/make-release && build/make-release ${CMake_VERSION_MAJOR} ${CMake_VERSION_MINOR} ${CMAKE_BINARY_DIR}")
