 ...
 * ALGEBRAIC[0] is c in component main (dimensionless).
 * ALGEBRAIC[1] is d in component main (dimensionless).
...
#define pret rfi->aPRET
  ALGEBRAIC[0] = p[0];
  ALGEBRAIC[1] = p[1];
  hx[0] = fixnans(( 3.00000*((pow(ALGEBRAIC[1], 3.00000))+ -1.00000*( 3.00000*ALGEBRAIC[0]))) - (0.00000));
  hx[1] = fixnans(( 2.00000*( -1.00000*STATES[0]+(pow(ALGEBRAIC[1], 3.00000))+ALGEBRAIC[0])) - (0.00000));
#undef VOI
#undef CONSTANTS
#undef RATES
#undef STATES
