...
SET(MSVC_DESCRIPTIVE "")
IF(WIN32)
  SET(CPACK_GENERATOR "NSIS;ZIP")
  IF(MSVC)
    IF (MSVC_VERSION == 1200)
      SET(MSVC_DESCRIPTIVE "MSVC6")
    ELSEIF(MSVC_VERSION == 1300)
      SET(MSVC_DESCRIPTIVE "MSVC7")
    ELSEIF(MSVC_VERSION == 1310)
      SET(MSVC_DESCRIPTIVE "MSVC7-1")
    ELSEIF(MSVC_VERSION == 1400)
      SET(MSVC_DESCRIPTIVE "MSVC8")
    ELSEIF(MSVC_VERSION == 1500)
      SET(MSVC_DESCRIPTIVE "MSVC9")
    ELSEIF(MSVC_VERSION == 1600)
      SET(MSVC_DESCRIPTIVE "MSVC10")
    ELSEIF(MSVC_VERSION == 1700)
      SET(MSVC_DESCRIPTIVE "MSVC12")
    ELSE()
      SET(MSVC_DESCRIPTIVE "MSVCUNKNOWN")
    ENDIF()
    IF(CMAKE_BUILD_TYPE MATCHES ".*Debug.*")
      SET(CPACK_PACKAGE_FILE_NAME "cellml-sdk-${CMake_VERSION_MAJOR}.${CMake_VERSION_MINOR}-Win32-${MSVC_DESCRIPTIVE}-Debug")
    ELSE(CMAKE_BUILD_TYPE MATCHES ".*Debug.*")
      SET(CPACK_PACKAGE_FILE_NAME "cellml-sdk-${CMake_VERSION_MAJOR}.${CMake_VERSION_MINOR}-Win32-${MSVC_DESCRIPTIVE}")
...
ADD_CUSTOM_TARGET(release chmod "+x" "build/make-release" COMMAND sh build/make-release ${CMake_VERSION_MAJOR} ${CMake_VERSION_MINOR} ${CMAKE_BINARY_DIR} ${MSVC_DESCRIPTIVE})
