/*
 * This file has been modified for the CellML DOM API to disable parts of levmar
 * which are not shipped with the CellML API.
 */
...
#ifdef NOT_INCLUDED_WITH_CELLMLAPI
...
#endif /* NOT_INCLUDED_WITH_CELLMLAPI */
