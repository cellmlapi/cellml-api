...
FOREACH(extension ${EXTENSION_LIST})
  ...
  SET(${extension}_java_defines_module)
...
FOREACH(extension ${EXTENSION_LIST})
  ...
  ENDFOREACH(dep)
  TARGET_LINK_LIBRARIES(${extension}_java_bridge ${deplibs} cellml)
  TARGET_LINK_LIBRARIES(java_${extension} ${deplibs} ${extension}_java_bridge cellml)
ENDFOREACH(extension)
